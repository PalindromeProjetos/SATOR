 ...
 */
Ext.define( 'Smart.util.CrossStorageClient', {

    alternateClassName: ['Smart.CrossStorageClient'],
    ...
    constructor: function (url, opts) {
        ...
        */
        if (typeof module !== 'undefined' && module.exports) {
            module.exports = Smart.util.CrossStorageClient;
        } else if (typeof exports !== 'undefined') {
            exports.Smart.util.CrossStorageClient = this;
        } else if (typeof define === 'function' && define.amd) {
            define([], function () {
                return this;
            });
        } else {
            Smart.util.CrossStorageClient = this;
        }
